...
@section('title')
    تقرير العملاء - برنامج إدارة الفواتير
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="Section" class="form-control select2" onclick="console.log($(this).val())"
                                ...
                                <!--placeholder-->
                                <option value="{{$sctionidT ?? ''}}" selected>{{$sectionnameT ?? 'حدد القسم'}}</option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <option value="{{$protype ?? ''}}" selected>{{$protype ?? ''}}</option>
                            </select>
                        </div>
...
<script>
    $(document).ready(function() {
        $('select[name="Section"]').on('change', function() {
            ...
            if (SectionId) {
                $.ajax({
                    url: "{{ URL::to('section_rpt') }}/" + SectionId,
                    type: "GET",
                    dataType: "json",
