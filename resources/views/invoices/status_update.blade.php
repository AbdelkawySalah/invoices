                    ...
                    <form action="{{ route('status_update', ['id' => $invoices->id]) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number1"
                                    title="يرجي ادخال رقم الفاتورة" required value="{{$invoices->invoice_number}}"
                                    readonly >
                                    <input type="hidden" class="form-control" id="inputid" name="invoice_id"
                                    value="{{$invoices->id}}">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ date('Y-m-d') }}" readonly required value="{{$invoices->invoice_Date}}">
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" readonly>
                                    <!--placeholder-->
                                    <option value="{{$invoices->section_id}}" readonly>{{$invoices->sections->section_name}}</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount" name="Discount"
                                    ...
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value=0 required value="{{$invoices->Discount}}" readonly>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Total" name="Total" readonly value="{{$invoices->Total}}" readonly>
                            </div>
                        </div>
