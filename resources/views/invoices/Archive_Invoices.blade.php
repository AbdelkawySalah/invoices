...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">أرشفة الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الفواتير</span>
						</div>
					</div>
...
@if (session()->has('Error'))
											...
											<tr>
												...
												<div class="col-sm-6 col-md-3">
													...
													<div class="dropdown-menu">
														...
														<a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
														 data-toggle="modal" data-target="#Cancel_Archiveinvoice"><i
														 class="text-danger fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي الفواتير
														  </a>
														</div>
                                                          </div>
                                                        </div>
    ...
    <div class="modal fade" id="Cancel_Archiveinvoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">الغاء  الأرشيف</h5>
                ...
                <div class="modal-body">
                    هل انت متاكد من عملية الغاء الأرشفة ؟
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    هل انت متاكد من عملية حذف الفاتورة نهائيا ؟
                    <input type="text" name="invoice_id" id="invoice_id" value="">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
...
<script>
        $('#Cancel_Archiveinvoice').on('show.bs.modal', function(event) {
