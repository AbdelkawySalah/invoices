...
@if (session()->has('delete_invoice'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم حذف الفاتورة نهئيا بنجاح",
                    type: "success"
                })
            }
				...
				<div class="col-xl-12">
						...
						<div class="card-header pb-0">
									...
									<a class="modal-effect btn btn-md btn-primary" href="{{ url('export_invoices') }}"
                                       style="color:white" title="تصدير اكسيل"><i class="fas fa-file-download"></i>&nbsp;تصدير اكسيل</a>
									  @endcan
						</div>
							<div class="card-body">
												...
												<div class="col-sm-6 col-md-3">
                                                    ...
                                                    @can('ارشفة الفاتورة')
                                                    	<a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
														 ...
														 class="text-danger fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي الأرشيف
														  </a>
                                                    @endcan
													@can('طباعةالفاتورة')
                                                    	  <a class="dropdown-item" href="Print_invoice/{{ $invoice->id }}"><i
														 class="text-success fas fa-print"></i>&nbsp;&nbsp;طباعه الفاتورة</a>
														<div class="dropdown-divider"></div>
                                                     @endcan	  												  	<!-- <a class="btn btn-outline-success btn-block" href="{{url('PaymentstatusChange')}}/{{$invoice->id}}">تغيير حالة الدفع</a> -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    هل انت متاكد من حذف الفاتورة نهائيا  ؟
	 ...
	 <div class="modal fade" id="Archive_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    هل انت متاكد من عملية نقل الفاتورة للارشيف ؟
                    <input type="text" name="invoice_id" id="invoice_id" value="">
